  ...
  Widget build(BuildContext context) {
    return
               Container(
                ...
                child: _batteryState == BatteryState.charging ? Icon(Icons.flash_on) : Container(child:Text("$_batteryLevel", style : TextStyle(fontSize: 15 ) )),
...
class _BatteryLevelPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double batteryRight = size.width + 4;
